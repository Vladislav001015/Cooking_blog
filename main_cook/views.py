...
from .models import *
from .permissions import UserHasPermissionsMixin
...
def add_recipe(request):
    ImageFormSet = modelformset_factory(Image, form=ImageForm, max_num=5, extra=2) #extra =2 (две фотографии обязательны для заполнения)
...
#     if request.method == 'POST':
#         recipe.delete()
#         messages.add_message(request, messages.SUCCESS, "Sucsessfully deleted")
#         return redirect('home')
#     return render(request, 'delete-recipe.html')


class DeleteRecipeView(UserHasPermissionsMixin, DeleteView):
    model = Recipe
    ...
    def delete(self, request, *args, **kwargs):
        ...
        self.object.delete()
        messages.add_message(request, messages.SUCCESS, "Successfprint('fffffffffffffffffffffffffffffffffffffffffffffffff')ully deleted")
